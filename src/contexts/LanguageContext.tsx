...
const translations = {
  en: {
    ...
    'team.photos.scroll': "Scroll to see more team photos",
  ...
  ko: {
    // Hero Section
    'hero.title.line1': "우리는 단순히 비디오를 번역하지 않습니다.",
    'hero.title.line2': "우리는 비디오를 재구성합니다.",
    'hero.subtitle': "모든 프레임, 모든 단어, 모든 목소리 — 우리의 AI는 글로벌 콘텐츠를 유창한 현지 경험으로 변환하여 비디오의 언어 장벽을 허물어뜨립니다.",
    ...
    // Tech Section
    'tech.title': "기술",
    'tech.subtitle': "우리는 비디오 현지화의 경계를 넓히는 AI 기술을 개발합니다.",
    'tech.agent.title': "에이전트 기반 번역 시스템",
    'tech.agent.description': "우리는 AI 에이전트를 사용하여 콘텐츠 장르, 톤, 문화에 적응하는 고품질의 맥락 인식 번역을 수행합니다.",
    'tech.lipSync.title': "립싱크 모델링",
    'tech.lipSync.description': "우리는 번역된 음성과 얼굴 움직임을 정렬하는 모델을 구축합니다 — 프레임 정확하고 감정을 보존합니다.",
    'tech.tts.title': "텍스트-투-스피치 (TTS)",
    'tech.tts.description': "우리의 맞춤형 TTS 시스템은 톤, 타이밍, 캐릭터 일관성에 맞춰진 네이티브 수준의 목소리를 생성합니다.",
    'tech.visual.title': "화면 텍스트 번역",
    'tech.visual.description': "인페인팅과 비전-언어 모델을 결합하여 원활한 번역을 제공하는 시각적 텍스트를 재구성합니다.",
    'tech.quote': "우리는 단순히 번역하는 것이 아니라 — 네이티브하게 보이고, 들리고, 느껴지는 비디오를 만드는 것을 목표로 합니다",
    
    // Collaborations Section
    'collaborations.title': "크리에이터와의 협업",
    'collaborations.subtitle': "우리는 현재 Veritasium, 3Blue1Brown, Welch Labs, Doctorfriends와 같은 선도적인 과학 채널들과 파트너십을 맺고 있어 그들의 콘텐츠를 높은 충실도와 세심한 배려로 새로운 관객들에게 접근 가능하게 만듭니다.",
    
    // Join Section
    'join.title': "함께하세요",
    'join.subtitle': "우리는 항상 열정적인 연구자, 엔지니어, 크리에이터, 디자이너를 찾고 있습니다.",
    'join.button': "연락하기",
    'nav.home': "홈",
    'nav.research': "연구",
    'nav.team': "팀",
    ...
    'research.jamflow.abstract.p1': "얼굴 움직임과 음성 간의 본질적인 연결은 비디오 현지화에서 종종 간과되며, 립싱크, 텍스트-투-스피치(TTS), 시각적 텍스트 번역이 일반적으로 별도의 작업으로 처리됩니다. 이 논문은 원활한 비디오 현지화를 위해 얼굴 움직임, 음성, 시각적 요소를 동시에 합성하고 조건화하는 통합 프레임워크인 CineLingo를 소개합니다.",
    ...
    'research.jamflow.abstract.p3': "엔드-투-엔드 목표로 훈련된 CineLingo는 텍스트, 참조 오디오, 참조 모션을 포함한 광범위한 조건화 입력을 지원하여 텍스트에서 동기화된 토킹 헤드 생성, 오디오 기반 애니메이션, 자동 더빙 등을 단일 일관된 모델 내에서 용이하게 합니다. CineLingo는 전체적인 비디오 현지화를 위한 실용적인 솔루션을 제공하여 멀티모달 생성 모델링을 크게 발전시킵니다.",
    ...
    'team.description': "CineLingo는 명기 권, 정재석과 공유된 열정을 가진 창의적인 개인들의 팀이 이끌고 있습니다. 우리는 연세대학교의 어영정, UW-Madison의 이용재와 창업자 및 투자자들의 모음이 지원합니다.",
    'team.location': "우리는 서울, 한국에 사무실이 있습니다. 우리 팀원들은 머신러닝, 소프트웨어, 엔터테인먼트 분야에서 오랜 경력을 가지고 있습니다.",
    'team.belief': "우리는 명확한 비전을 가진 작고 집중된 팀이 위대한 것들을 만들 수 있다고 강하게 믿습니다.",
    'team.photos.title': "우리 팀",
    'team.photos.scroll': "더 많은 팀 사진을 보려면 스크롤하세요",
